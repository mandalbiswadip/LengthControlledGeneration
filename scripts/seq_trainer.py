...
from transformers import init_deepspeed
...
class SeqToSeqNew(Seq2SeqTrainer):
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        self.length_schedule_sampling_decay_rate = .95
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    model.config.length_schedule_sampling_prob = model.config.length_schedule_sampling_prob_init * model.config.length_schedule_sampling_decay_rate ** (epoch + (step + 1) / steps_in_epoch)
                    model.zero_grad()
