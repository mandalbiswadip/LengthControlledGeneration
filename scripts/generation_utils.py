...
def beam_search_switch_tokens(
    ...
    **model_kwargs,
    ...
    # predict span length from encoder
    # build the length positions and segment ids
    ...
    while cur_len < max_length:
        ...
        outputs = self(
            **model_inputs,
            ...
            output_attentions=output_attentions,
            output_hidden_states=output_hidden_states,
            length_positions = length_positions[..., :cur_len],
            segment_ids = segment_ids[..., :cur_len],
        )
        next_token_logits = outputs.logits[:, -1, :]
